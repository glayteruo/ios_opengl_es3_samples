...
- (void)setupGL
{
	...
	// テクスチャ読み込み
	NSString* texPath = [[NSBundle mainBundle] pathForResource:@"animals_17_23_Small" ofType:@"ktx"];
	...
	glSamplerParameteri(_colorSampler, GL_TEXTURE_WRAP_S, GL_CLAMP_TO_EDGE);
	glSamplerParameteri(_colorSampler, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_EDGE);
	glSamplerParameteri(_colorSampler, GL_TEXTURE_MIN_FILTER, (hasMipmap) ? GL_LINEAR_MIPMAP_LINEAR : GL_LINEAR);
